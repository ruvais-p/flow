...
void showHistoryCategoryDialog(
                  ...
                  children: [
                    ...
                    CupertinoButton(
                      ...
                      onPressed: () async {
                        ...
                        await HistoryDBServices.instance.updateTransactionCategory(id, selectedCategory);
                        await HomepageDbServices.instance.updateCategoryInDb(id, selectedCategory);

                        // 🔥 Update the provider
                        final provider = Provider.of<HistoryDataProvider>(context, listen: false);
                        provider.updateTransactionCategory(id, selectedCategory);
                        final provider2 = Provider.of<TransactionListProvider>(context, listen: false);
                        provider2.updateTransactionCategory(id, selectedCategory);
                        // Optional callback
                        onCategoryUpdated();
