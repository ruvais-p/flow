...
class LastWeekChart extends StatelessWidget {
  LastWeekChart({super.key});
  ...
  Future<Map<String, List<WeakExpenss>>> getChartData() async {
    final debitData = await _databaseService.fetchLastWeekData('DEBIT');
    final creditData = await _databaseService.fetchLastWeekData('CREDIT');
